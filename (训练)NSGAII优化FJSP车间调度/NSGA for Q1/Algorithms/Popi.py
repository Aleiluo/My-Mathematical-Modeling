...
class Popi:
    ...
    def decode1(self):
        ...
        return self.JS.C_max,1e19,1e19
        # return self.JS.C_max, sum([self.JS.Machines[i].end[-1] 
        #                            for i in range(len(self.JS.Machines)) 
        #                            if len(self.JS.Machines[i].end) > 0]), 1e19
